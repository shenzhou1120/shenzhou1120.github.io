...
I study how multimodal Earth observation data can be transformed into robust and transferable representations for agricultural and environmental applications. My research focuses on multimodal remote sensing, spatiotemporal representation learning, crop yield prediction, and learning under limited supervision. My current work explores how satellite observations, meteorological forcing, and static environmental information can be jointly modeled to support high-resolution prediction and downstream geospatial tasks.

::: {.hero-contact}
[Email](mailto:shenzhouliu@whu.edu.cn) · [Google Scholar](https://scholar.google.com/citations?user=SPt69WYAAAAJ&hl=zh-CN) · [LinkedIn](https://www.linkedin.com/in/shenzhou-liu-5299872b6/)
:::
