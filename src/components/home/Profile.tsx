...
export default function Profile({ author, social, features, researchInterests }: ProfileProps) {
    ...
    useEffect(() => {
        ...
        const userHasLiked = localStorage.getItem('shenzhou-website-user-liked');
    ...
    const handleLike = () => {
        ...
        if (newLikedState) {
            localStorage.setItem('shenzhou-website-user-liked', 'true');
            setShowThanks(true);
            setTimeout(() => setShowThanks(false), 2000);
        } else {
            localStorage.removeItem('shenzhou-website-user-liked');
            setShowThanks(false);
        }
    };
        ...
        >
            ...
            <div className="w-64 h-64 mx-auto mb-6 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105">
                <Image
                    ...
                    width={256}
                    height={256}
                    className="w-full h-full object-cover object-[69%_center]"
                    priority
                />
            </div>
            ...
            {researchInterests && researchInterests.length > 0 && (
                <div className="bg-neutral-100 dark:bg-neutral-800 rounded-lg p-4 mb-6 hover:shadow-lg transition-all duration-200 hover:scale-[1.02]">
                    ...
                    <ul className="list-disc space-y-2 pl-5 text-sm text-neutral-700 marker:text-accent dark:text-neutral-500">
